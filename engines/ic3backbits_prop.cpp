...
IC3BackBitsProp::IC3BackBitsProp(const Property & p,
...
void IC3BackBitsProp::initialize()
{
...
IC3Formula IC3BackBitsProp::get_model_ic3formula() const
{
...
bool IC3BackBitsProp::ic3formula_check_valid(const IC3Formula & u) const
{
...
void IC3BackBitsProp::check_ts() const
{
  for (const auto & sv : ts_.statevars()) {
    const Sort & sort = sv->get_sort();
