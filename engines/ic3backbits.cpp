...
IC3BackBits::IC3BackBits(const Property & p,
...
IC3Formula IC3BackBits::get_model_ic3formula() const
{
...
bool IC3BackBits::ic3formula_check_valid(const IC3Formula & u) const
{
...
void IC3BackBits::check_ts() const
{
  for (const auto & sv : ts_.statevars()) {
    const Sort & sort = sv->get_sort();
