...
IC3BackBitsDual::IC3BackBitsDual(const Property & p,
...
void IC3BackBitsDual::initialize()
{
...
IC3Formula IC3BackBitsDual::get_model_ic3formula() const
{
...
bool IC3BackBitsDual::ic3formula_check_valid(const IC3Formula & u) const
{
...
void IC3BackBitsDual::check_ts() const
{
  for (const auto & sv : ts_.statevars()) {
    const Sort & sort = sv->get_sort();
